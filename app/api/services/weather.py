...
class WeatherService:
    ...
    async def get_time(self, geo_data, weather_data):
    ...
    async def get_geo_data(self, client, city):
    ...
    async def get_weather_data(self, client, latitude, longitude):
    ...
    async def get_weather(self, city):
        ...
        async with AsyncClient() as client:
            ...
            weather_data = await self.get_weather_data(
                client, geo_data['latitude'], geo_data['longitude']
            )
            ...
            return {
                ...
                'time': time,
                'temperature': f'{round(weather_data["temperature"])} °C',
